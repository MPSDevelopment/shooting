...
class WeaponTypeControllerTest {
    ...
    void checkGetTypeOfWeaponById() throws Exception {
        ...
        //try access with unauthorized user role
        mockMvc.perform(MockMvcRequestBuilders.get(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_GET_BY_ID.replace(ControllerAPI.REQUEST_WEAPON_TYPE_ID,type.getId().toString()))).andExpect(MockMvcResultMatchers.status().isUnauthorized());
    ...
    void checkPostTypeOfWeapon() throws Exception {
        ...
        //try access with unauthorized user role
        mockMvc.perform(MockMvcRequestBuilders.post(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_POST_TYPE).contentType(MediaType.APPLICATION_JSON_UTF8).content(json)).andExpect(MockMvcResultMatchers.status().isUnauthorized());

        //try access with user role
        mockMvc.perform(MockMvcRequestBuilders.post(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_POST_TYPE).contentType(MediaType.APPLICATION_JSON_UTF8).content(json).header(Token.TOKEN_HEADER,userToken)).andExpect(MockMvcResultMatchers.status().isForbidden());

        //try access with judge role
        mockMvc.perform(MockMvcRequestBuilders.post(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_POST_TYPE).contentType(MediaType.APPLICATION_JSON_UTF8).content(json).header(Token.TOKEN_HEADER,judgeToken)).andExpect(MockMvcResultMatchers.status().isForbidden());

        //try access with admin role
        String contentAsString = mockMvc.perform(MockMvcRequestBuilders.post(ControllerAPI.WEAPON_TYPE_CONTROLLER + ControllerAPI.VERSION_1_0 + ControllerAPI.WEAPON_TYPE_CONTROLLER_POST_TYPE).contentType(MediaType.APPLICATION_JSON_UTF8).content(json).header(Token.TOKEN_HEADER, adminToken)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn().getResponse().getContentAsString();
    ...
    void checkDeleteWeaponType() throws Exception {
        ...
        //try access with unauthorized user role
        mockMvc.perform(MockMvcRequestBuilders.delete(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_DELETE_TYPE_BY_ID.replace(ControllerAPI.REQUEST_WEAPON_TYPE_ID,bean.getId().toString()))).andExpect(MockMvcResultMatchers.status().isUnauthorized());

        //try access with user role
        mockMvc.perform(MockMvcRequestBuilders.delete(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_DELETE_TYPE_BY_ID.replace(ControllerAPI.REQUEST_WEAPON_TYPE_ID,bean.getId().toString())).header(Token.TOKEN_HEADER,userToken)).andExpect(MockMvcResultMatchers.status().isForbidden());

        //try access with judge role
        mockMvc.perform(MockMvcRequestBuilders.delete(ControllerAPI.WEAPON_TYPE_CONTROLLER+ControllerAPI.VERSION_1_0+ControllerAPI.WEAPON_TYPE_CONTROLLER_DELETE_TYPE_BY_ID.replace(ControllerAPI.REQUEST_WEAPON_TYPE_ID,bean.getId().toString())).header(Token.TOKEN_HEADER,judgeToken)).andExpect(MockMvcResultMatchers.status().isForbidden());

        //try access with admin role
        mockMvc.perform(MockMvcRequestBuilders.delete(ControllerAPI.WEAPON_TYPE_CONTROLLER + ControllerAPI.VERSION_1_0 + ControllerAPI.WEAPON_TYPE_CONTROLLER_DELETE_TYPE_BY_ID.replace(ControllerAPI.REQUEST_WEAPON_TYPE_ID,bean.getId().toString())).header(Token.TOKEN_HEADER, adminToken)).andExpect(MockMvcResultMatchers.status().isOk());
