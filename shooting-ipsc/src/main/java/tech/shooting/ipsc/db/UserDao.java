...
public class UserDao {
    ...
    public void upsert (User user) {
        ...
        var update =
            new Update().set(User.UPDATED_DATE_FIELD, OffsetDateTime.now(ZoneOffset.UTC)).setOnInsert(User.ID_FIELD, IdGenerator.nextId()).setOnInsert(User.CREATED_DATE_FIELD, OffsetDateTime.now(ZoneOffset.UTC)).setOnInsert(User.PASSWORD_FIELD, user.getPassword());
