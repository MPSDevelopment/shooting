...
public class DivisionController {
	...
	public ResponseEntity removeDivision (@PathVariable(value = ControllerAPI.PATH_VARIABLE_DIVISION_ID) Long id){
	...
	@ApiOperation(
			value = "Get division by id",
			notes = "Return division object")
	...
	@PutMapping(
			value = ControllerAPI.VERSION_1_0 + ControllerAPI.DIVISION_CONTROLLER_PUT_DIVISION,
			produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ApiOperation(
			value = "Update division",
			notes = "Return update division object")
	public ResponseEntity<DivisionBean> updateDivision (@PathVariable(value = ControllerAPI.PATH_VARIABLE_DIVISION_ID) Long id,
														@RequestBody @Valid UpdateDivisionBean updateDivisionBean) throws BadRequestException {
	...
	@ApiOperation(
			value = "Return root division",
			notes = "Return root division object")
