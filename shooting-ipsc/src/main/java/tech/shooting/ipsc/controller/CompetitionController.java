...
public class CompetitionController {
	...
	public ResponseEntity<Stage> getStage(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_STAGE_ID) Long stageId) throws BadRequestException {
	...
	public ResponseEntity<Void> deleteStage(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_STAGE_ID) Long stageId) throws BadRequestException {
	...
	public ResponseEntity<Stage> putStage(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_STAGE_ID) Long stageId, @RequestBody @Valid Stage stage)
	...
	public ResponseEntity<Void> deleteCompetitor(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long id, @PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITOR_ID) Long competitorId) throws BadRequestException {
	...
	public ResponseEntity<Competitor> getCompetitor(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long id, @PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITOR_ID) Long competitorId) throws BadRequestException {
	...
	public ResponseEntity<Competitor> getCompetitor(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long id, @PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITOR_MARK) String mark) throws BadRequestException {
	...
	public ResponseEntity<CompetitorMark> checkMarkForCompetitor(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITOR_ID) Long competitorId,
			@RequestBody @Valid CompetitorMark competitorMark) throws BadRequestException {
	...
	public ResponseEntity<Competitor> addedMarksForCompetitor(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITOR_ID) Long competitorId,
			@RequestBody @Valid CompetitorMarks competitorMark) throws BadRequestException {
		return new ResponseEntity<>(competitionService.addedMarkToCompetitor(competitionId, competitorId, competitorMark), HttpStatus.OK);
	}

	@GetMapping(value = ControllerAPI.VERSION_1_0 + ControllerAPI.COMPETITION_CONTROLLER_GET_CONST_ENUM_LEVEL, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	public ResponseEntity<List<Score>> createScoreOfListRows(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_STAGE_ID) Long stageId,
			@RequestBody @Valid List<ScoreBean> scoreBean) throws BadRequestException {
	...
	@PreAuthorize("hasRole('ADMIN') or hasRole('JUDGE')")
	@GetMapping(value = ControllerAPI.VERSION_1_0 + ControllerAPI.COMPETITION_CONTROLLER_GET_SCORE_LIST_BY_STAGE, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ApiOperation(value = "Get score list by stage")
	public ResponseEntity<List<Score>> getScoreListByStage(@PathVariable(value = ControllerAPI.PATH_VARIABLE_COMPETITION_ID) @NotNull Long competitionId, @PathVariable(value = ControllerAPI.PATH_VARIABLE_STAGE_ID) @NotNull Long stageId)
			throws BadRequestException {
		return new ResponseEntity<>(competitionService.getScoreList(competitionId, stageId), HttpStatus.OK);
	}

	@PreAuthorize("hasRole('ADMIN') or hasRole('JUDGE') or hasRole('GUEST')")
	@GetMapping(value = ControllerAPI.VERSION_1_0 + ControllerAPI.COMPETITION_CONTROLLER_GET_SCORE_LIST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ApiOperation(value = "Get score list by stage")
	...
	@PreAuthorize("hasRole('ADMIN') or hasRole('JUDGE') or hasRole('GUEST')")
	@GetMapping(value = ControllerAPI.VERSION_1_0 + ControllerAPI.COMPETITION_CONTROLLER_GET_RATING, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ApiOperation(value = "Get score list by stage")
	...
	@DeleteMapping(value = ControllerAPI.VERSION_1_0 + ControllerAPI.COMPETITION_CONTROLLER_DELETE_ALL_COMPETITION, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
