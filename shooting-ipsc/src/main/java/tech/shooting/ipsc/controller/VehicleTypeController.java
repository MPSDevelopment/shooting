...
public class VehicleTypeController {
	...
	public ResponseEntity<VehicleType> postTypeOfWeapon(@PathVariable(value = ControllerAPI.PATH_VARIABLE_TYPE_ID) long typeId, @RequestBody @Valid VehicleTypeBean bean) throws BadRequestException {
