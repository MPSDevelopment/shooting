...
import tech.shooting.tag.pojo.Token;
import tech.shooting.tag.pojo.Token.TokenType;
import tech.shooting.tag.pojo.TokenUser;
...
public class TokenUtils {
	...
	public TokenUtils(String secretCode) {
		algorithm = Algorithm.HMAC256(secretCode);
	...
	public boolean verifyToken(String token) {
		...
		try {
			...
			log.error("Error during token decode = %s", e.getMessage());
			return false;
		}
	}
}
